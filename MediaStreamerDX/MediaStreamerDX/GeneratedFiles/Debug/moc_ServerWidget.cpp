...
QT_MOC_LITERAL(2, 29, 0)
    ...
    "ServerWidget\0toggleStreaming\0"
};
...
void ServerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->toggleStreaming(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *ServerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ServerWidget"))
        return static_cast< Ui::ServerWidget*>(const_cast< ServerWidget*>(this));
